...
# multicycle sampling path in SGMII RX
set_max_delay -from [get_clocks *clk_625mhz_0_raw*] -through [get_cells -hierarchical *samples_*_2x_reg*] -to [get_clocks *clk_312p5mhz_raw*] 2.500
...
add_cells_to_pblock [get_pblocks pblock_ram] [get_cells -quiet [list buffer/bist buffer/bistmux buffer/infifo/decc_hi buffer/infifo/decc_lo buffer/infifo/ecc_hi buffer/infifo/ecc_lo buffer/qdr]]
...
set_property LOC IDELAYCTRL_X1Y1 [get_cells interfaces/iocal/delay_control_block]
...
resize_pblock [get_pblocks pblock_metafifo] -add {SLICE_X8Y100:SLICE_X23Y224 SLICE_X0Y100:SLICE_X7Y199}
...
add_cells_to_pblock [get_pblocks pblock_qspi] [get_cells -quiet [list mgmt/bridge mgmt/mgmt0_mdio_txvr]]
...
add_cells_to_pblock [get_pblocks pblock_mgmt] [get_cells -quiet [list mgmt/info mgmt/regs mgmt/rx_fifo mgmt/sensors mgmt/tach0 mgmt/tach1 mgmt/tx_fifo]]
...
set_property IOSTANDARD DIFF_HSTL_I_DCI_18 [get_ports g12_sgmii_rxclk_n]
...
set_property DRIVE 6 [get_ports dp_mdc]
set_property DRIVE 6 [get_ports dp_mdio]
set_property DRIVE 6 [get_ports mgmt0_mdc]
set_property DRIVE 6 [get_ports mgmt0_mdio]
set_property DRIVE 4 [get_ports {pmod_dq[7]}]
set_property DRIVE 4 [get_ports {pmod_dq[6]}]
set_property DRIVE 4 [get_ports {pmod_dq[5]}]
set_property DRIVE 4 [get_ports {pmod_dq[4]}]
set_property DRIVE 4 [get_ports {pmod_dq[3]}]
set_property DRIVE 4 [get_ports {pmod_dq[2]}]
set_property DRIVE 4 [get_ports {pmod_dq[1]}]
set_property DRIVE 4 [get_ports {pmod_dq[0]}]
set_property SLEW SLOW [get_ports mgmt0_mdc]
set_property SLEW SLOW [get_ports {qdr_a[20]}]
set_property SLEW SLOW [get_ports {qdr_a[19]}]
set_property SLEW SLOW [get_ports {qdr_a[18]}]
set_property SLEW SLOW [get_ports {qdr_a[17]}]
set_property SLEW SLOW [get_ports {qdr_a[16]}]
set_property SLEW SLOW [get_ports {qdr_a[15]}]
set_property SLEW SLOW [get_ports {qdr_a[14]}]
set_property SLEW SLOW [get_ports {qdr_a[13]}]
set_property SLEW SLOW [get_ports {qdr_a[12]}]
set_property SLEW SLOW [get_ports {qdr_a[11]}]
set_property SLEW SLOW [get_ports {qdr_a[10]}]
set_property SLEW SLOW [get_ports {qdr_a[9]}]
set_property SLEW SLOW [get_ports {qdr_a[8]}]
set_property SLEW SLOW [get_ports {qdr_a[7]}]
set_property SLEW SLOW [get_ports {qdr_a[6]}]
set_property SLEW SLOW [get_ports {qdr_a[5]}]
set_property SLEW SLOW [get_ports {qdr_a[4]}]
set_property SLEW SLOW [get_ports {qdr_a[3]}]
set_property SLEW SLOW [get_ports {qdr_a[2]}]
set_property SLEW SLOW [get_ports {qdr_a[1]}]
set_property SLEW SLOW [get_ports {qdr_a[0]}]
set_property DRIVE 6 [get_ports vsc_mdc]
set_property DRIVE 6 [get_ports vsc_mdio]
set_property DRIVE 6 [get_ports vsc_mdio_oe]

set_property PULLUP true [get_ports g13_int_n]
set_property PULLUP true [get_ports g12_int_n]

set_property PULLDOWN true [get_ports {g12_gpio[1]}]
set_property PULLDOWN true [get_ports {g12_gpio[0]}]
set_property PULLDOWN true [get_ports {g13_gpio[1]}]
set_property PULLDOWN true [get_ports {g13_gpio[0]}]



set_property DRIVE 6 [get_ports g12_rst_n]
set_property DRIVE 6 [get_ports g13_rst_n]
set_property SLEW SLOW [get_ports g13_rst_n]
...
set_clock_groups -asynchronous -group [get_clocks interfaces/port_g0_g11/inst/qsgmii_transceiver_i/gt0_qsgmii_transceiver_i/gtxe2_i/RXOUTCLK] -group [get_clocks interfaces/port_g0_g11/inst/qsgmii_transceiver_i/gt0_qsgmii_transceiver_i/gtxe2_i/TXOUTCLK]
...
set_clock_groups -asynchronous -group [get_clocks interfaces/port_g0_g11/inst/qsgmii_transceiver_i/gt1_qsgmii_transceiver_i/gtxe2_i/RXOUTCLK] -group [get_clocks interfaces/port_g0_g11/inst/qsgmii_transceiver_i/gt1_qsgmii_transceiver_i/gtxe2_i/TXOUTCLK]
...
set_clock_groups -asynchronous -group [get_clocks interfaces/port_g0_g11/inst/qsgmii_transceiver_i/gt2_qsgmii_transceiver_i/gtxe2_i/RXOUTCLK] -group [get_clocks interfaces/port_g0_g11/inst/qsgmii_transceiver_i/gt2_qsgmii_transceiver_i/gtxe2_i/TXOUTCLK]
set_false_path -from [get_clocks interfaces/port_g0_g11/inst/qsgmii_transceiver_i/gt0_qsgmii_transceiver_i/gtxe2_i/RXOUTCLK] -to [get_clocks clk_125mhz_raw]
set_false_path -from [get_clocks interfaces/port_g0_g11/inst/qsgmii_transceiver_i/gt1_qsgmii_transceiver_i/gtxe2_i/RXOUTCLK] -to [get_clocks clk_125mhz_raw]
set_false_path -from [get_clocks interfaces/port_g0_g11/inst/qsgmii_transceiver_i/gt2_qsgmii_transceiver_i/gtxe2_i/RXOUTCLK] -to [get_clocks clk_125mhz_raw]
